...
const Footer = () => (
  <div className='main-footer mt-5'>
    <Row className='mx-5'>
      <Col>
        ...
        <ul className='list-unstyled'>
          <li>
            <a href='./pages/computer' target='_blank'>
              Computer
            </a>
          </li>
          <li>
    ...
    <Row className='mt-3 mx-5 pb-5'>
      <Col>
        <p>&copy;{new Date().getFullYear()} Intellcap Store | All rights reserved</p>
      </Col>
      <Col>
        <p>Follow Us</p>
        <a
          class='btn btn-outline-secondary rounded-circle socMedLinks'
          href='https://www.facebook.com/pages/category/Science--Technology---Engineering/Intellcap-105447604693856/'
          role='button'
          target='_blank'
        >
